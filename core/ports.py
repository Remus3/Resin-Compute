...
Sibling-C additionally reserves 2999, far outside the 88xx range, because a
third-party desktop application owns that number and binds it - the reservation
records somebody else's port rather than claiming one. It is deliberately NOT
listed as a block here: it is not a reservation this project could ever collide
with by allocating inside 8790-8809.

The vendor is not named. It was, and naming it identified Sibling-C directly,
